...
def detectCharsInPlates(listOfPossiblePlates):
    # Detects the characters present on all the rectangular plates
    intPlateCounter = 0
    imgContours = None
    contours = []
...
def findPossibleCharsInPlate(imgGrayscale, imgThresh):
    # Filters the rectangular plates and returns the possible plates with characters
    listOfPossibleChars = []
    contours = []
...
def checkIfPossibleChar(possibleChar):
    # Method to check the printed font is a character with PIXELS width
